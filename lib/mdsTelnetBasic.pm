# $Header: /home/kbreslin/cvs/bohem/lib/mdsTelnetBasic.pm,v 1.1 2009-05-26 14:39:26 kbreslin Exp $
# This file borrowed from CVSROOT:qa/tools/suites/CPMS/perl/mdsTelnet.pm
...
# mdsTelnet.pm
#
# $Revision: 1.1 $  $Modtime: 13/11/02 11:15a $
#
#############################################################################


package mdsTelnetBasic;
...
sub new
{
    ...
    bless $obj, 'mdsTelnetBasic';                    #return the reference to this object
    return $obj;
}
