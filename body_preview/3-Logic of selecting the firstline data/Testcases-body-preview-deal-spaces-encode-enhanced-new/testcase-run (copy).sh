...
t2="ASCII-LF   testing"
t3="Chinese-UTF8-8bit-CRLF    Testing"
t4="Chinese-UTF8-8bit-LF      Testing"
t5="Chinese-GBK-8bit-CRLF     Testing"
t6="Chinese-GBK-8bit-LF       Testing"
t7="Japanese-UTF8-8bit-CRLF   Testing"
t8="Japanese-UTF8-8bit-LF     Testing"
t9="Japanese-EUC-JP-8bit-CRLF Testing"
t10="Japanese-EUC-JP-8bit-LF   Testing"
t11="Japanese-Shift_JIS-8bit-CRLF Testing"
t12="Japanese-Shift_JIS-8bit-LF   Testing"
t13="Japanese-GBK-8bit-CRLF  Testing"
t14="Japanese-GBK-8bit-LF    Testing"
t15="Arabic-UTF8-8bit-CRLF   Testing"
t16="Arabic-UTF8-8bit-LF     Testing"
t17="Arabic-ISO-8859-6-8bit-CRLF  Testing"
t18="Arabic-ISO-8859-6-8bit-LF    Testing"
t19="mixed-UTF-8-language-IMAP-and-SMTP Testing"
...
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-ASCII-chars-CRLF
bash logic-messagesend-SMTP.sh  #SMTP
cd  ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Chinese-UTF8-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Chinese-UTF8-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Chinese-GBK-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Chinese-GBK-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-UTF8-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-UTF8-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-EUC-JP-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-EUC-JP-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-Shift_JIS-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-Shift_JIS-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-GBK-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Japanese-GBK-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Arabic-UTF8-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Arabic-UTF8-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Arabic-ISO-8859-6-8bit-CRLF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd IMAP-and-SMTP-Arabic-ISO-8859-6-8bit-LF
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
...
echo -en "\n" >>all-summary.log
cd mixed-UTF-8-language-IMAP-and-SMTP
bash logic-messagesend-IMAP-append.sh   #IMAP
cd ..
