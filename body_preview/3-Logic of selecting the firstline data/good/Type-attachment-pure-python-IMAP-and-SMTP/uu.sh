...
linenu=`grep -n charset  $name-IMAP-7bit.txt |awk -F : '{print $1}' `
let newline=$linenu+1
#echo $newline
sed -i ''$newline'd' $name-IMAP-7bit.txt
sed -i '/charset/a\Content-Transfer-Encoding: 7bit'  $name-IMAP-7bit.txt

linenu=`grep -n charset  $name-IMAP-8bit.txt |awk -F : '{print $1}'`
let newline=$linenu+1
sed -i ''$newline'd' $name-IMAP-8bit.txt
sed -i '/charset/a\Content-Transfer-Encoding: 8bit'  $name-IMAP-8bit.txt

linenu=`grep -n charset  $name-IMAP-base64.txt |awk -F : '{print $1}'  `
let newline=$linenu+1
sed -i ''$newline'd' $name-IMAP-base64.txt
sed -i '/charset/a\Content-Transfer-Encoding: base64'  $name-IMAP-base64.txt

linenu=`grep -n charset  $name-IMAP-quoted.txt |awk -F : '{print $1}'`
let newline=$linenu+1
sed -i ''$newline'd' $name-IMAP-quoted.txt
sed -i '/charset/a\Content-Transfer-Encoding: quoted-printable'  $name-IMAP-quoted.txt


linenu=`grep -n charset  $name-SMTP-7bit.txt |awk -F : '{print $1}' `
let newline=$linenu+1
sed -i ''$newline'd' $name-SMTP-7bit.txt
sed -i '/charset/a\Content-Transfer-Encoding: 7bit'  $name-SMTP-7bit.txt

linenu=`grep -n charset  $name-SMTP-8bit.txt |awk -F : '{print $1}'`
let newline=$linenu+1
sed -i ''$newline'd' $name-SMTP-8bit.txt
sed -i '/charset/a\Content-Transfer-Encoding: 8bit'  $name-SMTP-8bit.txt

linenu=`grep -n charset  $name-SMTP-base64.txt |awk -F : '{print $1}'`
let newline=$linenu+1
sed -i ''$newline'd' $name-SMTP-base64.txt
sed -i '/charset/a\Content-Transfer-Encoding: base64'  $name-SMTP-base64.txt

linenu=`grep -n charset  $name-SMTP-quoted.txt |awk -F : '{print $1}'`
let newline=$linenu+1
sed -i ''$newline'd' $name-SMTP-quoted.txt
sed -i '/charset/a\Content-Transfer-Encoding: quoted-printable'  $name-SMTP-quoted.txt
