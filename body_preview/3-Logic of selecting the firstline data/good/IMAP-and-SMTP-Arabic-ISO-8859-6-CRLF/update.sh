...
##########################################################################
subject1=testemail-Arabic-ISO-8859-6-CRLF-7bit                                       #
subject2=testemail-Arabic-ISO-8859-6-CRLF-8bit                                       #
subject3=testemail-Arabic-ISO-8859-6-CRLF-base64                                     #
subject4=testemail-Arabic-ISO-8859-6-CRLF-quoted-printable                           #
charsets=ISO-8859-6                                                           #
##########################################################################
...
#add some variables
sed -i '/#!/a\subject1=testemail-Arabic-ISO-8859-6-CRLF-7bit\nsubject2=testemail-Arabic-ISO-8859-6-CRLF-8bit\nsubject3=testemail-Arabic-ISO-8859-6-CRLF-base64\nsubject4=testemail-Arabic-ISO-8859-6-CRLF-quoted-printable\ncharsets=ISO-8859-6\n'  logic-messagesend-SMTP-*.sh 
...
sed -i  '/cat message$i.txt/s/message$i.txt/message$i-7bit.txt/g'  logic-messagesend-SMTP-7bit.sh
...
sed -i  '/cat message$i.txt/s/message$i.txt/message$i-8bit.txt/g'  logic-messagesend-SMTP-8bit.sh
...
sed -i  '/cat message$i.txt/s/message$i.txt/message$i-base64.txt/g'  logic-messagesend-SMTP-base64.sh
...
sed -i  '/cat message$i.txt/s/message$i.txt/message$i-quoted.txt/g'  logic-messagesend-SMTP-quoted.sh


#edit imap sh files -logic-messagesend-IMAP-append-7bit.sh
sed -i 's/message-append$i/message-append$i-7bit/g'  logic-messagesend-IMAP-append-7bit.sh  #change
#edit imap sh files -logic-messagesend-IMAP-append-8bit.sh
sed -i 's/message-append$i/message-append$i-8bit/g'  logic-messagesend-IMAP-append-8bit.sh  #change
#edit imap sh files -logic-messagesend-IMAP-append-base64.sh
sed -i 's/message-append$i/message-append$i-base64/g'  logic-messagesend-IMAP-append-base64.sh  #change
#edit imap sh files -logic-messagesend-IMAP-append-quoted.sh
sed -i 's/message-append$i/message-append$i-quoted/g'  logic-messagesend-IMAP-append-quoted.sh  #change
