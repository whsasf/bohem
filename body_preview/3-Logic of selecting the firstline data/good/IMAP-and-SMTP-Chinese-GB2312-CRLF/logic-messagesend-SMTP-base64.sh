#!/bin/bash
subject1=testemail-Chinese-GB2312-CRLF-7bit
subject2=testemail-Chinese-GB2312-CRLF-8bit
subject3=testemail-Chinese-GB2312-CRLF-base64
subject4=testemail-Chinese-GB2312-CRLF-quoted-printable
charsets=gb2312
...
echo "/////////////////////////////////// -1- Chinese words \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"
echo "/////////////////////////////////// -1- Chinese words \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"  >summary.log
#sedning messages
for ((i=1;i<=$count;i++ ))
do
	echo -e "\n\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!Sending message$i!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
...
diff fetch-target2.txt  fetch-template-base64.txt >diff-temp.log
...
diff uidfetch-target2.txt  uidfetch-template-base64.txt >diff-temp.log
