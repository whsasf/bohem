#!/bin/bash
subject1=testemail-Japanese-GB2312-CRLF-7bit
subject2=testemail-Japanese-GB2312-CRLF-8bit
subject3=testemail-Japanese-GB2312-CRLF-base64
subject4=testemail-Japanese-GB2312-CRLF-quoted-printable
charsets=gb2312
...
do
  ...
  echo -en "DATA\r\n" >&3
  #echo -en "Subject: testmessage$i-Japanes-GB2312-CRLF\r\n" >&3
