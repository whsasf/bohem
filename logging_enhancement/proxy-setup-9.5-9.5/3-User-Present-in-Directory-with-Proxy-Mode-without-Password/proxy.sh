...
#imconfcontrol -install -key "/*/imapserv/imapProxyHost=imap://10.49.58.118:20143";
#imconfcontrol -install -key "/*/imapserv/imapProxyPort=20143";
#imconfcontrol -install -key "/*/popserv/popProxyHost=pop://10.49.58.118:20110";
