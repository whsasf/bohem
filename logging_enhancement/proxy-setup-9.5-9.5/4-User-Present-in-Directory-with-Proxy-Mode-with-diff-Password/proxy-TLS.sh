...
tragett1="fromhost=10.37.2.214:fromport=|fromhost=\[10.37.2.214\]:fromport="
tragett2="fromhost=10.49.58.127:fromport=|fromhost=\[10.49.58.127\]:fromport="
...
#MX9.5-2: 
curl -s -X PUT -d "cosId=default&password=px&smtpAuthenticationEnabled=yes" "http://$mos2/mxos/mailbox/v2/$testaccount1/"|jq .
curl -s -X PUT -d "cosId=default&password=px&smtpAuthenticationEnabled=yes" "http://$mos2/mxos/mailbox/v2/$testaccount2/"|jq .
